...
DayNightOverlay.NORTH_ = {lat: 85, lng: 0}
...
DayNightOverlay.SOUTH_ = {lat: -85, lng: 0}
...
/** @override */
DayNightOverlay.prototype.draw = function(ctx, width, height) {
  ...
  var visibleDim = this.getVisibleDimensions_(projection, 0);
 ...
 * atlas (i.e. the rectangular area from (90Â°N,180Â°W) to (90Â°S,180Â°E)).
...
DayNightOverlay.prototype.createTerminatorFunc_ = function(viewport, world) {
  ...
  // over the equator on the vernal and autumnal equinox, 23.44Â° north at the
  // summer solstice and 23.44Â° south at the winter solstice). Between those
...
if (window && window.document) {
  window.DayNightOverlay = DayNightOverlay
}
